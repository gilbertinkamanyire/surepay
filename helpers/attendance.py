...
def log_attendance(user_id, category_id, lesson_id, activity_type):
    """Log a student's activity and award participation points."""
    g.db.execute(
        'INSERT INTO attendance (user_id, category_id, lesson_id, activity_type) VALUES (?, ?, ?, ?)',
        (user_id, category_id, lesson_id, activity_type)
    )
